...
public class 중첩_집계_단일_쿼리_생성기 implements 쿼리_생성기 {
	...
	public static 쿼리_생성기 of(기본_검색_집계_하위_요청 기본_검색_집계_하위_요청, EsQuery esQuery){
		return new 중첩_집계_단일_쿼리_생성기(기본_집계_쿼리.of(기본_검색_집계_하위_요청, esQuery));
	}

	public static 쿼리_생성기 week(기본_검색_집계_하위_요청 기본_검색_집계_하위_요청, EsQuery esQuery){
		return new 중첩_집계_단일_쿼리_생성기(일자별_집계_쿼리.week(기본_검색_집계_하위_요청, esQuery));
	}
	...
	public static 쿼리_생성기 day(기본_검색_집계_하위_요청 기본_검색_집계_하위_요청, EsQuery esQuery){
		return new 중첩_집계_단일_쿼리_생성기(일자별_집계_쿼리.day(기본_검색_집계_하위_요청, esQuery));
	}
