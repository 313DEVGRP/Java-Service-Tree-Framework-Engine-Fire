...
public class 일반_집계_쿼리 extends 공통_집계_쿼리<TermsAggregationBuilder>{
    ...
    private 일반_집계_쿼리(기본_집계_요청 _일반_집계_요청, EsQuery esQuery){
        super(
            _일반_집계_요청
            ,esQuery
    ...
    public static 일반_집계_쿼리 of(EsQuery esQuery){
        return new 일반_집계_쿼리(new 기본_집계_요청() {},esQuery);
    }

    public static 일반_집계_쿼리 of(기본_집계_요청 일반_집계_요청, EsQuery esQuery){
