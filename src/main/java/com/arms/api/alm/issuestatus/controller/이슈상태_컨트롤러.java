package com.arms.api.alm.issuestatus.controller;

import com.arms.api.alm.issuestatus.model.이슈상태_데이터;
import com.arms.api.alm.issuestatus.service.이슈상태_전략_호출;
...
public class 이슈상태_컨트롤러 {
    ...
    public List<이슈상태_데이터> 온프레미스_이슈상태_목록_가져오기(@PathVariable("connectId") Long 연결_아이디,
