...
import com.arms.api.alm.issue.base.service.jiraissue_schedule.alm_entity_sync.ALM_수집_데이터_지라이슈_엔티티_삭제_처리;
import com.arms.api.alm.issue.base.service.jiraissue_schedule.alm_entity_sync.연결이슈_처리;
...
public class ALM_수집_데이터_증분_지라이슈_엔티티_동기화 {
	...
	public ALM_수집_데이터_증분_지라이슈_엔티티_동기화(지라이슈_벌크_추가_요청 지라이슈_벌크_추가_요청값) {
		...
		this.연결이슈_처리 = new 연결이슈_처리(지라이슈_데이터,지라이슈_벌크_추가_요청값);
