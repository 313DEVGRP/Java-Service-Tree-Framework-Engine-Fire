...
public class ALM_수집_데이터_지라이슈_엔티티_동기화_팩토리 {
	...
	public static ALM_수집_데이터_증분_지라이슈_엔티티_동기화 ALM_수집_데이터_증분_지라이슈_엔티티_동기화_생성(지라이슈_벌크_추가_요청 지라이슈_벌크_추가_요청값){

		ALM_수집_데이터_증분_지라이슈_엔티티_동기화 alm_수집_데이터_증분_지라이슈_엔티티_동기화
			= new ALM_수집_데이터_증분_지라이슈_엔티티_동기화(
				지라이슈_벌크_추가_요청값
		...
		if (alm_수집_데이터_증분_지라이슈_엔티티_동기화.가져온_ALM_이슈_있음()) {
