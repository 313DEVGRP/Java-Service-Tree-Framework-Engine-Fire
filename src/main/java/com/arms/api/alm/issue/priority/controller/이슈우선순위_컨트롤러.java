...
import com.arms.api.alm.issue.priority.service.이슈우선순위_전략_호출;
...
public class 이슈우선순위_컨트롤러 {
    ...
    public List<이슈우선순위_데이터> 우선순위_목록_가져오기(@PathVariable("connectId") Long 연결_아이디) {
        로그.info("이슈 우선순위_목록_가져오기 :: 연결_아이디 :: {}", 연결_아이디);
