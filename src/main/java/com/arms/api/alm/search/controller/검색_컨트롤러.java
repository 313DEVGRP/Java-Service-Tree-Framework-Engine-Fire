...
import com.arms.api.alm.issue.base.service.jiraissue_search.지라이슈_검색_서비스;
...
public class 검색_컨트롤러 {
    ...
    public ResponseEntity<버킷_집계_결과_목록_합계> 검색엔진_플루언트디_로그네임_집계_top5(@RequestParam("search_string") String 검색어,
        ...
        집계_요청.set끝_날짜(끝_날짜);
        집계_요청.set컨텐츠_보기_여부(false);
        집계_요청.set페이지(0);
        집계_요청.set크기(5);
        집계_요청.set메인_그룹_필드("@log_name");
    ...
    public ResponseEntity<버킷_집계_결과_목록_합계> 검색엔진_이슈_프로젝트명_집계_top5(@RequestParam("search_string") String 검색어,
        ...
        집계_요청.set페이지(0);
        집계_요청.set크기(5);
        집계_요청.set메인_그룹_필드("project.project_name.keyword");
