...
public class 플루언트디_서비스_프로세스 implements 플루언트디_서비스{
    ...
    public 검색어_검색결과<SearchHit<플루언트디_인덱스>> 플루언트디_검색(검색어_기본_검색_요청 검색어_기본_검색_요청){
        ...
        SearchHits<플루언트디_인덱스> 플루언트디_검색결과 = 플루언트디_저장소.search(일반_검색_쿼리_생성기.of(검색어_기본_검색_요청, esQuery).생성());
        검색어_검색결과<SearchHit<플루언트디_인덱스>> 검색결과_목록 = new 검색어_검색결과<>();
    ...
    @Override
    public 검색어_검색결과<SearchHit<플루언트디_인덱스>> 플루언트디_날짜포함_검색(검색어_날짜포함_검색_요청 검색어_날짜포함_검색_요청) {
        ...
        SearchHits<플루언트디_인덱스> 플루언트디_검색결과 = 플루언트디_저장소.search(일반_검색_쿼리_생성기.of(검색어_날짜포함_검색_요청, esQuery).생성());
        검색어_검색결과<SearchHit<플루언트디_인덱스>> 검색결과_목록 = new 검색어_검색결과<>();
