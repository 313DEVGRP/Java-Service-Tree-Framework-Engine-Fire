...
public class 지라이슈_스케쥴_컨트롤러 {
    ...
    public 지라이슈 요구사항이슈_조회(@PathVariable("connectId") Long 지라서버_아이디,
        ...
        return 지라이슈_서비스.이슈_조회하기(조회조건_아이디);
    }
    ...
    public 지라이슈 이슈_검색엔진_저장(@PathVariable("connectId") Long 지라서버_아이디,
        ...
        return 지라이슈_서비스.이슈_검색엔진_저장(지라서버_아이디, 이슈_키, 제품서비스_아이디, 제품서비스_버전_아이디들, cReqLink);
    }
    ...
    public int 이슈_검색엔진_벌크_저장(@PathVariable("connectId") Long 지라서버_아이디,
        ...
        return 지라이슈_서비스.이슈_링크드이슈_서브테스크_벌크로_추가하기(지라서버_아이디, 이슈_키, 제품서비스_아이디, 제품서비스_버전_아이디들, cReqLink);
    }
    ...
    public int 증분이슈_링크드이슈_서브테스크_벌크추가(@PathVariable("connectId") Long 지라서버_아이디,
        ...
        return 지라이슈_서비스.증분이슈_링크드이슈_서브테스크_벌크추가(지라서버_아이디, 이슈_키, 제품서비스_아이디, 제품서비스_버전_아이디들, cReqLink);
    }
