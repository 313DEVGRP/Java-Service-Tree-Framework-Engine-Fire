...
public class 플루언트디_서비스구현체 implements 플루언트디_서비스{
    ...
    @Override
    public 검색결과_목록_합계 전체_집계결과_가져오기(쿼리_추상_팩토리 쿼리추상팩토리) {
    ...
    @Override
    public 검색결과_목록_합계 플루언트디_로그네임_집계(검색어_집계_요청 검색어_집계_요청) {
        String start_date = null;
        String end_date = null;
        ...
        검색결과_목록_합계 집계_결과 = this.전체_집계결과_가져오기(일반_집계_쿼리_생성기.of(검색어_집계_요청, esQuery));
        return 집계_결과;
    }
}
